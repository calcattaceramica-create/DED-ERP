...
class Employee(db.Model):
    ...
    # Unique constraints
    __table_args__ = (
        db.UniqueConstraint('employee_number', 'tenant_id', name='uq_employee_number_tenant'),
        db.UniqueConstraint('national_id', 'tenant_id', name='uq_employee_national_id_tenant'),
    )
...
class Department(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('code', 'tenant_id', name='uq_department_code_tenant'),
    )
...
class Position(db.Model):
    ...
    # Unique constraint: code + tenant_id
    __table_args__ = (
        db.UniqueConstraint('code', 'tenant_id', name='uq_position_code_tenant'),
    )
...
class Attendance(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('employee_id', 'attendance_date', 'tenant_id', name='uq_attendance_employee_date_tenant'),
    )
...
class Payroll(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('employee_id', 'month', 'year', 'tenant_id', name='uq_payroll_employee_month_year_tenant'),
    )
