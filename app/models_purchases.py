...
class Supplier(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('code', 'tenant_id', name='uq_supplier_code_tenant'),
    )
...
class PurchaseOrder(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('order_number', 'tenant_id', name='uq_purchase_order_number_tenant'),
    )
...
class PurchaseInvoice(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('invoice_number', 'tenant_id', name='uq_purchase_invoice_number_tenant'),
    )
...
class PurchaseReturn(db.Model):
    ...
    return_number = db.Column(db.String(64), nullable=False)
    ...
    # Unique constraint: return_number + tenant_id
    __table_args__ = (
        db.UniqueConstraint('return_number', 'tenant_id', name='uq_purchase_return_number_tenant'),
    )
