...
# -*- coding: utf-8 -*-
"""
إضافة صلاحيات settings.company.* لدور المدير
"""
...
with app.app_context():
    print("=" * 100)
    print("🔧 إضافة صلاحيات settings.company.* لدور المدير")
    print("=" * 100)
    ...
    print("✅ تم الانتهاء!")
    print("=" * 100)
    print("\n📝 الآن المستخدم ali يستطيع:")
    print("   ✅ عرض بيانات الشركة")
    print("   ✅ تعديل بيانات الشركة")
    print("=" * 100)
